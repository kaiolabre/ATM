 ...
 * @author 5704
 */
public class NetSavingsAccount extends Account implements Interest{
// Withdraw limit in this account cannot be changed by the user    
//pre set withdraw limit
    private static float withdrawLimit = 1000;
    ...
    //give Netsavings account its own attributes
    public NetSavingsAccount(String accountName, String accountType, int accountNumber, int accountBSB, float accountBalance) {
  ...
  /////////////////////////////////////////////// WITHDRAW
    ...
    public float calculateInterest() {
        float interest = (accountBalance / 100) * 3; //3% interest
        // update accountBalance
        accountBalance = accountBalance + interest;
        System.out.println("The interest of this account is 3%: AUD "+interest);
