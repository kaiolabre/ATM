...
public class WithdrawScreen extends javax.swing.JFrame {
    ...
    /**
     * Creates new form WithdrawScren
     */
    ...
    private void initComponents() {
        ...
        selectAccountComboBox.setName(""); // NOI18N
        ...
        selectAccountComboBox.getAccessibleContext().setAccessibleDescription("");
        selectAccountComboBox.getAccessibleContext().setAccessibleParent(null);
    ...
    private void bOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bOKActionPerformed
        ...
        if (selectedAccount == "Savings Account"){
           int feedback  = da.withdrawSavingsAccount((int) amount);
           
           if (feedback == 0) {
               JOptionPane.showMessageDialog(null, "Ooops! Something went wrong.");
           }
           else if (feedback == 1) {
               JOptionPane.showMessageDialog(null, "You cannot withdraw more than your withdraw limit.");
               //TODO diplay current withdraw limit
           }
           else if (feedback == 2) {
               JOptionPane.showMessageDialog(null, "Out of Balance! \n Your current balance is: $ " + da.viewSavingsAccountBalance());               
           }
           else if (feedback == 3){
               JOptionPane.showMessageDialog(null, "Withdraw Successful! \n Your new Balance is: $" + da.viewSavingsAccountBalance());
           }
           else if (feedback == 4) {
               JOptionPane.showMessageDialog(null, "Oops! Enter a valid value!");
           }
           else if (feedback == 5) {
               JOptionPane.showMessageDialog(null, "Unable to withdraw! \n This ATM only uses 20, 50 and 100 dolars notes.");
           }           
